                        ...
                        <Layout style={{ marginTop: 20, marginLeft: '10vw', marginRight: '1vw', width: '60vw' }}>
                            ...
                            <Content className="site-layout-background" style={{
                                ...
                                <Row>
                                    <Col>
                                        <Row>
                                            <div style={{ margin: 10, marginBottom: 0, direction: "column" }} width={'70vw'} height={50} >
                                                <span style={{ fontWeight: 400, fontSize: 30, color: "black" }}>
                                                    {props.title}
                                                </span>

                                                <Icon icon={eyeFilled} style={{ color: "lightGray", marginLeft: 15, marginTop: 5 }} height={18} />
                                                <span style={{ fontWeight: 300, fontSize: 22, color: "lightGray", marginLeft: 5, marginBottom: 5 }}>
                                                    {"2.4k"}
                                                </span>
                    ...
                    <Row >
                        <Layout style={{ marginTop: 20, marginLeft: '10vw', marginRight: '2vw', width: '60vw' }}>
                            ...
                            <Content className="site-layout-background" style={{
                                ...
                                <span style={{ fontWeight: 500, fontSize: 22, color: "black", textJustify: "auto", marginLeft: 10 }}> {"Комментарии: 1"} </span>
                                <br></br>
